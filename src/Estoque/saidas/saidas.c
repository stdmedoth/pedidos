...
int est_saidas()
{
	...
	gtk_fixed_put(GTK_FIXED(est_said_est_fixed),est_said_est_frame,20,60);
	...
	est_said_ped_frame = gtk_frame_new("Pedido");
	...
	gtk_fixed_put(GTK_FIXED(est_said_ped_fixed),est_said_ped_frame,20,20);
