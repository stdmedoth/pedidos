int import_tits(){
  ...
  imprt_tits_confirmar_button = gtk_button_new_with_label("Iniciar");
  gtk_button_set_image(GTK_BUTTON( imprt_tits_confirmar_button ),gtk_image_new_from_file(IMG_OK));
  ...
  gtk_box_pack_start(GTK_BOX(caixa_opcoes),imprt_tits_confirmar_button,0,0,5);
  ...
  g_signal_connect(imprt_tits_confirmar_button,"clicked",G_CALLBACK(import_tits_iniciar),NULL);
