int cad_titulos_receber(){
    ...
    gtk_combo_box_text_insert_text(GTK_COMBO_BOX_TEXT(cad_rec_status_combo),0,"Pendente");
    gtk_combo_box_text_insert_text(GTK_COMBO_BOX_TEXT(cad_rec_status_combo),1,"Baixado");
    ...
    gtk_box_pack_start(GTK_BOX(linha1),cad_rec_parcela_fixed,0,0,0);
    gtk_box_pack_start(GTK_BOX(linha2),cad_rec_cli_fixed,0,0,0);
    gtk_box_pack_start(GTK_BOX(linha2),cad_rec_ped_fixed,0,0,0);
    gtk_box_pack_start(GTK_BOX(linha3),cad_rec_datacriacao_fixed,0,0,0);
    gtk_box_pack_start(GTK_BOX(linha3),cad_rec_datavencimento_fixed,0,0,0);
    gtk_box_pack_start(GTK_BOX(linha4),cad_rec_valor_fixed,0,0,0);
    gtk_box_pack_start(GTK_BOX(linha4),cad_rec_status_fixed,0,0,0);
