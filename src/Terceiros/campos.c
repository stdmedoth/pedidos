...
(razao, doc,   ie,	  tipo_doc, tipoc,  tipo,  cep,   endereco,  cidade,   uf,   numrua,  tiporua,  celular,   contatoc,  telefone,  contatot,  email,  contatoe,		transp_nome,	transp_num,	transp_logradouro,  transp_cidade, transp_estado,	transp_cep,      transp_telefone,   transp_cnpj,    transp_ie,    transp_obs,       obs,    frete_pago,    vlr_frete_pago,    prazo ) values\
('%s', '%s',  '%s',      %i,    '%s',   %i,    '%s',   '%s',     '%s',    '%s',    %s,       %i,      '%s',      '%s',      '%s',      '%s',     '%s',    '%s' ,			'%s',			%s,			'%s',            	'%s',  	   		'%s',		'%s',				'%s',			  '%s',			  '%s',			'%s',			'%s',	   %i,				%s,		      '%s');"
