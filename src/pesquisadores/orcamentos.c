void receber_orc_code(GtkWidget *button, GtkTreeView *treeview)
{
	...
	gtk_widget_destroy(psq_orc_wnd);
}

int entry_orc_pesquisa(GtkEntry *widget, GtkTreeView *treeview)
{
...
int psq_orc(GtkWidget *button, GtkEntry *cod_orc_entry)
{
	enum {N_COLUMNS=5,COLUMN0=0, COLUMN1=1, COLUMN2=2, COLUMN3=3, COLUMN4=4};
	...
	pesquisa_global_alvo = GTK_ENTRY(cod_orc_entry);
		g_signal_connect(treeview,"row-activated",G_CALLBACK(receber_psq_code_space),psq_orc_wnd);
