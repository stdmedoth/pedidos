...
int entry_cntrat_pesquisa(GtkEntry *widget, GtkTreeView *treeview)
{
	...
	tipo_psq = gtk_combo_box_get_active(GTK_COMBO_BOX(psq_cntrat_combo_box));
...
int psq_cntrat(GtkWidget *button, GtkEntry *cod_cntrat_entry)
{
	...
	psq_cntrat_combo_box = gtk_combo_box_text_new();
	gtk_combo_box_text_append(GTK_COMBO_BOX_TEXT(psq_cntrat_combo_box),"0","Nome");
	gtk_combo_box_text_append(GTK_COMBO_BOX_TEXT(psq_cntrat_combo_box),"1","UF");
	gtk_combo_box_text_append(GTK_COMBO_BOX_TEXT(psq_cntrat_combo_box),"2","DDD");
	gtk_combo_box_set_active(GTK_COMBO_BOX(psq_cntrat_combo_box),0);
	...
	gtk_box_pack_start(GTK_BOX(caixa_grande),psq_cntrat_combo_box,0,0,0);
	...
	g_signal_connect(pesquisa_entry,"activate",G_CALLBACK(entry_cntrat_pesquisa),treeview);
