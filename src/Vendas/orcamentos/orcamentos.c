...
{		
	...
	gtk_combo_box_set_active(GTK_COMBO_BOX(tipodesconto_prod_orc_combo[itens_qnt]),1);
...
int vnd_orc()
{
	...
	{	
		...
		g_signal_connect(preco_prod_orc_entry[itens_qnt],"key-release-event",G_CALLBACK(prc_cli_alter),id_vetor[cont]);
