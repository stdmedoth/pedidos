...
int  cad_prod()
{
	...
	*horizontal_box_six;
	...
	gtk_box_pack_start(GTK_BOX(horizontal_box_four),qnt_atacado,0,0,10);
	...
	gtk_fixed_put(GTK_FIXED(fixed),horizontal_box_five,MARGEM_D+20,300); 
	
	gtk_fixed_put(GTK_FIXED(fixed2),horizontal_box_four,MARGEM_D,20);
