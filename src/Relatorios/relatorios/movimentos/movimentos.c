void relat_mov_fun()
{
	...
	gtk_fixed_put(GTK_FIXED(relat_mov_code_fixed),relat_mov_code_frame,20,20);
	...
	gtk_fixed_put(GTK_FIXED(relat_mov_nome_fixed),relat_mov_nome_frame,20,20);
	...
	gtk_fixed_put(GTK_FIXED(relat_mov_query_fixed),relat_mov_query_frame,20,80);
	...
	gtk_grid_attach(GTK_GRID(grid),relat_mov_query_fixed,0,2,1,1);
