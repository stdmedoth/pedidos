...
//cadastros 
GtkWidget *prd_ico, *prd_lbl;
GtkWidget *ter_ico, *ter_lbl;
GtkWidget *est_ico, *est_lbl;
GtkWidget *opr_ico, *opr_lbl;
GtkWidget *trs_ico, *trs_lbl;
GtkWidget *und_ico, *und_lbl;
//compras
