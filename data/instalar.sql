...
create table terceiros ( code int primary key auto_increment not null, razao varchar(300) not null, doc varchar(20), tipo_doc int not null, tipoc varchar(20), tipo int, cep varchar(15) , endereco varchar(400), numrua int, tiporua int, telefone varchar(15), contatot varchar(15), celular varchar(15), contatoc varchar(15), email varchar(100), contatoe varchar(20), prazo varchar(20), obs varchar(500));
